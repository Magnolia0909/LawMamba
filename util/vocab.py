...
with open("/home/sxx/experiment/data/law_data/test_json_v3.json", "r", encoding="utf-8") as f:
    data = json.load(f)
    for entry in data:
        if "contract" in entry:
            all_texts.append(entry["contract"])

with open("/home/sxx/experiment/data/law_data/train_json_v3.json", "r", encoding="utf-8") as f:
    test_data = json.load(f)
    for entry in test_data:
        if "contract" in entry:
            all_texts.append(entry["contract"])

law_df = pd.read_csv("/home/sxx/experiment/data/law_data/law.csv", encoding="utf-8")
...
with open("/home/sxx/experiment/data/law_data/te/vocab.txt", "w", encoding="utf-8") as vocab_file:
...
# 打开文件并计算行数
with open('/home/sxx/experiment/data/law_data/te/vocab.txt', "r", encoding="utf-8") as file:
